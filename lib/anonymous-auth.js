...
function isValidAccountName(accountName) {
    // Use centralized validation from validators module
    // This validates against sdc-ufds canonical LOGIN_RE and UUID_RE patterns
    return (validators.isValidAccountIdentifier(accountName));
}
