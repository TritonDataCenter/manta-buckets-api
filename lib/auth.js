...
function preSignedUrl(req, res, next) {
    ...
    // For S3 presigned URLs, set up S3-style auth context
    if (req._s3PresignedConverted) {
        ...
        log.debug('preSignedUrl: S3 presigned URL auth completed');
    }
...
function loadCaller(req, res, next) {
    ...
    function gotCaller(err, info) {
        ...
        // Create sanitized caller object for logging (remove sensitive data)
        var sanitizedCaller = {
