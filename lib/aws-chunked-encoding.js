 ...
 *
 * CRITICAL: Not setting the decoded size correctly will cause Mako to fail
 * on V2 commit with error: "there is a discrepancy in one of the parts"
 *
...
function configureAwsChunkedEncoding(req, partReq, partNumber, uploadId) {
    ...
    req.log.debug({
        ...
        decodedLength: partReq.headers[constants.S3_HEADERS.DECODED_CONTENT_LENGTH]
