 ...
 *
 * Two signalling conventions are accepted:
 *   1. Content-Encoding: aws-chunked   (older awscli, some SDKs)
 *   2. x-amz-content-sha256: STREAMING-AWS4-HMAC-SHA256-PAYLOAD
 *      (AWS SigV4 streaming protocol — mc, AWS SDK for Go, etc.)
 *
 * Without (2), clients that follow the SigV4 streaming spec but omit
 * Content-Encoding upload the raw chunked frame as object data.
 */
