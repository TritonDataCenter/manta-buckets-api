 ...
 * raw object name as input the to metadata location hash function was made in
 * order to allow us to construct the storage file path such that all the inputs
 * the the metadata placement hash function are present on the storage node and
