...
function translateBucketError(req, err) {
    ...
    case 'PreconditionFailedError':
        req.precondition_failed_error = err;
        /*
         * XXX At this point perhaps we should figure out the response code?
         *
         * Also need to figure out what to do about 304 Not Modified.  These
         * should likely be returned from buckets-mdapi as an error, but do they
         * get handled here?  We're in the error path of a request at this
         * point.
         */
        err = new restifyErrors.PreconditionFailedError(err.message);
        //log.fatal({ err: err, headers: req.headers }, 'xxx');
        break;
    default:
        break;
    }
