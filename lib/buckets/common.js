...
function _list(type, req, bucket_id) {
    ...
    paginationStream(opts,
        function onRecord(record) {
            ...
            log.debug({paginationRecord: record}, 'onRecord: processing record');
            ...
            if (record.name) {
                ...
                log.debug({record: record}, 'skipping record without name or bucket_name');
                return;
            }
                ...
                func: function (vnode, cb2) {
                    ...
                    o.lmstream.getNextRecord(function (record, isDone) {
                        ...
                        if (record.created) {
                            ...
                            log.debug({record: record}, 'record missing created field');
                        }
                        o.record = record;
                        cb2();
                    });
