...
function createObject(req, res, next) {
    ...
    buckets.createObjectMetadata(req, type,
        ...
        _lapTime('createObject-createObjectMetadata');
        ...
        var onCreateObject = function onCreate(createErr2, response_data) {
            _lapTime('createObject-createObject');
        ...
        _lapTime('createObject-getObjectLocation');

        var client =
            req.metadataPlacement.getBucketsMdapiClient(metadataLocation);

        _lapTime('createObject-getBucketsMdapiClient');
