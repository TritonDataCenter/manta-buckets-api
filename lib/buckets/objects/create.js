...
var translateBucketErrors = require('../common').translateBucketErrors;
...
function createObject(req, res, next) {
    ...
    buckets.createObjectMetadata(req, type,
        ...
        var onCreateObject = function onCreate(createErr2, response_data) {
            ...
            if (createErr2) {
                createErr2 = translateBucketErrors(createErr2);
...
function parseArguments(req, res, next)  {
    ...
    if (copies < common.DEF_MIN_COPIES || copies > maxObjectCopies) {
