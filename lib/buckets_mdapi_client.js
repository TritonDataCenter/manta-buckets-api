...
function createClient(options, callback) {
    ...
    pnodes.forEach(function createClientForPnode(pnode) {
        ...
        function createFilteredLogger(logger, suppress) {
            return {
                child: function createChildLogger(childOptions) {
                ...
                error: function logFilteredError(err, msg) {
                    ...
                    (errorToCheck.name === 'BucketNotFound' ||
                        ...
                        errorToCheck.name === 'PreconditionFailedError' ||
