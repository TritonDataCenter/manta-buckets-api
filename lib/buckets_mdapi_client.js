...
function createClient(options, callback) {
    ...
    pnodes.forEach(function (pnode) {
        ...
        // Create a completely filtered logger for buckets-mdapi to suppress user errors
        ...
        function createFilteredLogger(logger, suppress) {
            return {
                child: function(childOptions) {
                    return createFilteredLogger(logger.child(childOptions), suppress);
                },
                level: logger.level,
                ...
                error: function(err, msg) {
                    ...
                    if (errorToCheck && (
                        ...
                        (errorToCheck.message && (
                            ...
                            errorToCheck.message.includes('requested bucket not found') ||
                            errorToCheck.message.includes('requested object not found') ||
        ...
        var filteredLogger = createFilteredLogger(baseLogger, suppressUserErrors);
