...
var BadRequestError = restifyErrors.BadRequestError;
var PreconditionFailedError = restifyErrors.PreconditionFailedError;

var IF_MATCH_FAIL = 'xxx if-match \'%s\' didn\'t match etag \'%s\'';
var IF_NO_MATCH_FAIL = 'xxx if-none-match \'%s\' matched etag \'%s\'';
var IF_MOD_FAIL = 'xxx object was modified at \'%s\'; if-modified-since \'%s\'';
var IF_UNMOD_FAIL = 'xxx object was modified at \'%s\'; if-unmodified-since \'%s\'';
