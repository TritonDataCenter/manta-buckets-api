...
util.inherits(DirectoryLimitError, BucketsApiError);
...
util.inherits(DirectoryOperationError, BucketsApiError);
...
util.inherits(InvalidJobError, BucketsApiError);
...
util.inherits(InvalidLinkError, BucketsApiError);
...
util.inherits(JobStateError, BucketsApiError);
...
util.inherits(JobNotFoundError, BucketsApiError);
...
util.inherits(LinkNotFoundError, BucketsApiError);
...
util.inherits(LinkNotObjectError, BucketsApiError);
...
util.inherits(LinkRequiredError, BucketsApiError);
...
util.inherits(ParentNotDirectoryError, BucketsApiError);
...
util.inherits(RootDirectoryError, BucketsApiError);
...
util.inherits(SnaplinksDisabledError, BucketsApiError);
...
function translateError(err, req) {
    if (err instanceof BucketsApiError || err instanceof restify.HttpError)
        return (err);
