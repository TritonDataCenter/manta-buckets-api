...
function IAMClient(options) {
     ...
     */
    if (options.agent) {
        clientOpts.agent = options.agent;
    }
...
IAMClient.prototype.createRole = function createRole(opts, callback) {
    ...
    this.client.post(path, requestData,
                      function handleCreateRoleResponse(err, req, res, data) {
        if (err) {
            log.debug({
                err: err,
                roleName: opts.roleName,
...
IAMClient.prototype.getRole = function getRole(opts, callback) {
    ...
    this.client.get({
        path: path,
        query: query
    }, function handleGetRoleResponse(err, req, res, data) {
        if (err) {
            log.debug({
                err: err,
                roleName: opts.roleName,
...
IAMClient.prototype.putRolePolicy = function putRolePolicy(opts, callback) {
    ...
    this.client.post(path, requestData,
        function handlePutRolePolicyResponse(err, req, res, data) {
        if (err) {
            log.debug({
                err: err,
                roleName: opts.roleName,
...
IAMClient.prototype.deleteRolePolicy =
    ...
    this.client.del({
        path: path,
        query: requestData
    }, function handleDeleteRolePolicyResponse(err, req, res, data) {
        if (err) {
            log.debug({
                err: err,
                roleName: opts.roleName,
...
IAMClient.prototype.deleteRole = function deleteRole(opts, callback) {
    ...
    this.client.del({
        path: path,
        query: requestData
    }, function handleDeleteRoleResponse(err, req, res, data) {
        if (err) {
            log.debug({
                err: err,
                roleName: opts.roleName,
...
IAMClient.prototype.listRoles = function listRoles(opts, callback) {
    ...
    this.client.get({
        path: path,
        query: requestData
    }, function handleListRolesResponse(err, req, res, data) {
        if (err) {
            log.debug({
                err: err,
                callerUuid: opts.caller.account.uuid,
...
IAMClient.prototype.listRolePolicies =
    ...
    self.client.get(reqOpts,
                     function handleListRolePoliciesResponse(err, req, res,
                                                              data) {
        if (err) {
            log.debug({
                err: err,
...
IAMClient.prototype.getRolePolicy = function getRolePolicy(opts, callback) {
    ...
    self.client.get(reqOpts,
                     function handleGetRolePolicyResponse(err, req, res, data) {
        if (err) {
            log.debug({
                err: err,
                statusCode: res ? res.statusCode : null,
