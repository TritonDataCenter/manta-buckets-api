                ...
                switch (method) {
                    ...
                    case 'POST':
                        ...
                        if (query.delete !== undefined || 
                            (typeof queryString === 'string' && queryString.includes('delete'))) {
                            s3Request.operation = 'DeleteBucketObjects';
                            req.log.debug('S3_DEBUG: Detected bulk delete operation');
                        } else {
                            req.log.warn('S3_WARN: Unsupported POST operation for bucket:', method);
                        }
                        break;
                    default:
                        // Log unexpected method but don't fail parsing
