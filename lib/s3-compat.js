        ...
        if (pathParts.length === 0) {
            ...
            if (isSigV4) {
                ...
                if (query.uploads !== undefined) {
                    ...
                    req.log.debug('S3_DEBUG: Detected InitiateMultipartUpload operation');
                    ...
                    switch (method) {
                        ...
                        case 'POST':
                            ...
                            req.log.warn('S3_WARN: Unsupported POST operation for object:', method);
                            break;
                        default:
                            // Log unexpected method but don't fail parsing
                            req.log.warn('S3_WARN: Unexpected HTTP method in object operations:', method);
                            break;
                    }
                }
            }
