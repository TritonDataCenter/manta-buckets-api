...
function parseS3Request(req) {
    ...
    console.log('S3_DEBUG_QUERY_MAIN: parsed query object:', JSON.stringify(query));
            ...
            if (pathParts.length >= 1 && pathParts[0] === bucketFromHost) {
                ...
                if (pathParts.length === 1) {
                    ...
                    switch (method) {
                        case 'GET':
                            ...
                            if (query['list-type'] === '2') {
                                ...
                                console.log('S3_DEBUG_CONSOLE: Set operation to ListBucketObjectsV2 for GET /bucket');
                            } else {
                        ...
                        default:
                            ...
                            console.log('S3_DEBUG_CONSOLE: Unexpected HTTP method in bucket operations:', method);
                            break;
                    }
                } else {
                    ...
                    switch (method) {
                        ...
                        default:
                            // Log unexpected method but don't fail parsing
                            console.log('S3_DEBUG_CONSOLE: Unexpected HTTP method in object operations:', method);
                            break;
                    }
                }
            } else {
                ...
                if (pathParts.length === 0) {
                    ...
                    switch (method) {
                        case 'GET':
                            ...
                            if (query['list-type'] === '2') {
                                s3Request.operation = 'ListBucketObjectsV2';
                                console.log('S3_DEBUG_CONSOLE: Set operation to ListBucketObjectsV2 for virtual-hosted GET');
                            } else {
                                s3Request.operation = 'ListBucketObjects';
                        ...
                        default:
                            // Log unexpected method but don't fail parsing
                            console.log('S3_DEBUG_CONSOLE: Unexpected HTTP method in virtual-hosted bucket operations:', method);
                            break;
                    }
                } else {
                    ...
                    switch (method) {
                        ...
                        default:
                            // Log unexpected method but don't fail parsing
                            console.log('S3_DEBUG_CONSOLE: Unexpected HTTP method in virtual-hosted object operations:', method);
                            break;
                    }
                }
            }
            ...
            if (isSigV4) {
                ...
                switch (method) {
                    case 'GET':
                        ...
                        console.log('S3_DEBUG_QUERY: parseS3Request - query object:', JSON.stringify(query));
                        console.log('S3_DEBUG_QUERY: parseS3Request - list-type value:', query['list-type']);
                        console.log('S3_DEBUG_QUERY: parseS3Request - list-type === "2":', query['list-type'] === '2');
                        
                        if (query['list-type'] === '2') {
                            s3Request.operation = 'ListBucketObjectsV2';
                            console.log('S3_DEBUG_QUERY: parseS3Request - SET OPERATION TO ListBucketObjectsV2');
                        } else {
                            s3Request.operation = 'ListBucketObjects';
                            console.log('S3_DEBUG_QUERY: parseS3Request - SET OPERATION TO ListBucketObjects');
                        }
                        console.log('S3_DEBUG_FINAL_OPERATION: parseS3Request - FINAL OPERATION SET TO:', s3Request.operation);
                        console.log('S3_DEBUG_FINAL_OPERATION: parseS3Request - FINAL s3Request OBJECT:', JSON.stringify(s3Request, null, 2));
                        break;
                    case 'PUT':
                        s3Request.operation = 'CreateBucket';
                        break;
...
function convertMantaToS3Response(mantaBody, operation, s3Request, caller) {
    ...
    switch (operation) {
        ...
        case 'ListBucketObjects':
            console.log('S3_DEBUG_CONVERSION: ❌ USING convertObjectListToS3 (V1) - NO <KeyCount>');
        ...
        case 'ListBucketObjectsV2':
            console.log('S3_DEBUG_CONVERSION: ✅ USING convertObjectListToS3V2 - THIS SHOULD GENERATE <KeyCount>');
            console.log('S3_DEBUG: convertMantaToS3Response - calling convertObjectListToS3V2 with bucket:', s3Request.bucket);
            var v2Result = convertObjectListToS3V2(mantaBody, s3Request.bucket);
            console.log('S3_DEBUG_CONVERSION: convertObjectListToS3V2 result preview:', v2Result.substring(0, 300));
            return v2Result;
...
function convertBucketListToS3(mantaResponse, caller) {
    ...
    console.log('S3_DEBUG: convertBucketListToS3 - caller data:', JSON.stringify(caller, null, 2));
    ...
    if (caller && caller.account) {
        ...
        console.log('S3_DEBUG: convertBucketListToS3 - extracted owner info: ID=' + ownerID + ', DisplayName=' + ownerDisplayName);
    } else {
        console.log('S3_DEBUG: convertBucketListToS3 - no caller/account info, using defaults');
    }
    ...
    console.log('S3_DEBUG: convertBucketListToS3 - generated XML with IsTruncated field:');
