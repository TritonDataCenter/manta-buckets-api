 ...
 * @param {Number} sourceSize   total source object size
 * @returns {Object|null}  {start, end, length} or null
 */
function parseCopySourceRange(rangeHeader, sourceSize) {
    if (!rangeHeader) {
        return (null);
    }
    ...
    bucketHelpers.loadRequest(sourceReq, null,
        ...
        bucketHelpers.getBucketIfExists(sourceReq, null,
            ...
            copyModule.getSourceObjectMetadata(sourceReq,
                ...
                var range = parseCopySourceRange(
                    rangeHdr, srcMeta.content_length);
