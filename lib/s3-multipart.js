...
function listUploadedParts(req, uploadId, uploadRecord, callback) {
    ...
    function listNextPage() {
        ...
        mreq.on('entry', function (entry) {
            ...
            // IMPORTANT: For s3cmd resume to work correctly, we need to prioritize
            // MD5 format over UUID format in list-parts responses. s3cmd uses
            // these ETags for resume detection and expects consistent MD5 format.
