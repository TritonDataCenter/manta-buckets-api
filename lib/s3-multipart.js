            ...
            (function skipLockingAndProceed() {
                ...
                assembleMultipartUpload(req, uploadRecord, commitBody,
                    ...
                    if (assembleErr) {
                        ...
                        // TEMPORARILY DISABLED: Lock release on assembly error (no locking active)
                        return next(new
                                    InternalError(
                    ...
                    cleanupMultipartUpload(req, uploadId,
                        ...
                        // TEMPORARILY DISABLED: Lock release (no locking active)
                        res.setHeader('Content-Type', 'application/xml');
                        res.send(200, xml);
                        next(false);
                    }); // Close cleanupMultipartUpload callback
