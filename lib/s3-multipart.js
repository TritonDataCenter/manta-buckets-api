...
function buildPartUploadRequest(req, uploadRecord, bucketName, partKey,
    ...
    configurePreAllocatedSharks(partReq, req, uploadRecord, partNumber, uploadId);
...
function ensureBucketAndApplyCors(req, res, next, partReq) {
    ...
    loadBucketForCors(req, function(err) {
 ...
 * ============================================================================
 * Extracted helpers for s3CompleteMultipartUploadHandler to reduce complexity
 * from 428 lines/9 nesting levels to ~60 lines/3 nesting levels.
 */
