...
function streamAndAssembleParts(req, partPaths, callback) {
    ...
    // Use durability level from upload record, fall back to request headers
    var uploadRecord = req._uploadRecord;
    var copies = (uploadRecord && uploadRecord.durabilityLevel) ||
    ...
    }, 'S3_MPU: Using durability level for streaming assembly');

    allocateSharks();

    function allocateSharks() {
    ...
    } // End of allocateSharks function
}
