        ...
        bucketHelpers.getBucketIfExists(uploadReq, null, function (bucketErr) {
            ...
            client.getObject(owner, uploadReq.bucket.id, uploadRecordKey,
                ...
                try {
                    ...
                    if (result.headers &&
                        result.headers['x-durability-level-metadata']) {
                        uploadRecord.durabilityLevel =
                            parseInt(result.headers
                                     ['x-durability-level-metadata'], 10);
                    }
                    ...
                    }, 'S3_MPU: Retrieved durability level' +
                                  ' from upload record metadata');
