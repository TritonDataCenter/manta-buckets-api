...
/*
 * This is used to determine how to break up object names into a series of
 * nested directory names in order to avoid running up against the maximum file
 * name length of the file system.
 */
var OBJECT_NAME_PART_SIZE = 128;
...
function storagePath(opts) {
    ...
    var owner = opts.creator || opts.owner;
    ...
    var objectIdPrefix = objectId.substr(0, 2);

    return (path.join(storageLayoutVersion, owner, bucketId, objectIdPrefix,
        objectIdAndHash));
}
...
module.exports = {
    OBJECT_NAME_PART_SIZE: OBJECT_NAME_PART_SIZE,
