...
helper.test('deriveSigningKey - different dates produce different keys', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('deriveSigningKey - different regions produce different keys', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var service = 's3';
...
helper.test('calculateChunkSignature - produces valid signature format', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('calculateChunkSignature - different data produces different signatures', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('calculateChunkSignature - signature chain works correctly', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('verifyChunkSignature - accepts valid signature', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('verifyChunkSignature - rejects invalid signature', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('verifyChunkSignature - rejects tampered data', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('verifyChunkSignature - rejects wrong previous signature', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('Edge case: empty chunk data (end-of-stream marker)', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    var signature = verifier.calculateChunkSignature(
        signingKey, previousSignature, timestamp, credentialScope, emptyChunk
    );

    t.ok(signature, 'should generate signature for empty chunk');
    t.equal(signature.length, 64, 'empty chunk signature should be 64 hex chars');
...
helper.test('Edge case: very large chunk data (1MB)', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    var signature = verifier.calculateChunkSignature(
        signingKey, previousSignature, timestamp, credentialScope, largeChunk
    );
...
helper.test('Edge case: binary data with null bytes', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    var binaryChunk = new Buffer([0x00, 0xFF, 0x00, 0xAB, 0xCD, 0xEF, 0x00]);

    var signature = verifier.calculateChunkSignature(
        signingKey, previousSignature, timestamp, credentialScope, binaryChunk
    );
    ...
    t.ok(isValid, 'binary data with null bytes should verify correctly');

    t.end();
});

helper.test('Edge case: single byte tampering detection', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    var originalData = new Buffer('The quick brown fox jumps over the lazy dog');
...
helper.test('Edge case: signature case sensitivity', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
...
helper.test('Edge case: malformed signature - wrong length', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    // Too long
    var longSignature = 'ad80c730a21e5b8d04586a2213dd63b9a0e99e0e2307b0ade35a65485a288648' +
...
helper.test('Edge case: malformed signature - invalid hex characters', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    var invalidSignature = 'ZZZZZZZZA21e5b8d04586a2213dd63b9a0e99e0e2307b0ade35a65485a288648';
    ...
    t.notOk(isValid, 'signature with invalid hex should be rejected');

    t.end();
});

helper.test('Edge case: different service names produce different keys', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';

    var s3Key = verifier.deriveSigningKey(secretKey, dateStamp, region, 's3');
    var ec2Key = verifier.deriveSigningKey(secretKey, dateStamp, region, 'ec2');
...
helper.test('Edge case: signature chain break detection', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    // Try to verify chunk 2 with wrong previous signature (using seed instead of chunk1Sig)
    var isValid = verifier.verifyChunkSignature(
        signingKey, seedSignature, timestamp, credentialScope,
        chunk2Data, chunk2Sig
    );

    t.notOk(isValid, 'chunk 2 verification should fail with wrong previous signature in chain');

    t.end();
});

helper.test('Edge case: identical chunks produce different signatures in chain', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    var chunk1Sig = verifier.calculateChunkSignature(
        signingKey, seedSignature, timestamp, credentialScope, identicalData
    );

    var chunk2Sig = verifier.calculateChunkSignature(
        signingKey, chunk1Sig, timestamp, credentialScope, identicalData
    );

    t.notEqual(chunk1Sig, chunk2Sig,
        'identical data in consecutive chunks should produce different signatures');

    t.end();
});

helper.test('Edge case: empty previous signature string', function (t) {
    var secretKey = 'wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY';
    var dateStamp = '20130524';
    var region = 'us-east-1';
    var service = 's3';
    ...
    // Empty string as previous signature (invalid but shouldn't crash)
    var signature = verifier.calculateChunkSignature(
        signingKey, '', timestamp, credentialScope, chunkData
    );

    t.ok(signature, 'should generate signature even with empty previous signature');
    t.equal(signature.length, 64, 'signature should still be 64 hex chars');
